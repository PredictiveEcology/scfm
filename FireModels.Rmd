...
modules <- list("ageModule", "scfmIgnition","scfmEscape", "scfmSpread") #,"ignitionModule")
...
ageMapInit <- raster::raster(file.path(baseDir, "age", "age.tif"))
