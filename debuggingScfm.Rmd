...
Require(c("data.table", "ggplot2",
          "LandR","magrittr", "terra", 
          "SpaDES.core", "sf"), upgrade = FALSE)
```
...
center <- terra::vect(cbind(-1209980,y = 7586865))
crs(center) <- paste("+proj=lcc +lat_1=49 +lat_2=77 +lat_0=0 +lon_0=-95 +x_0=0 +y_0=0", 
            "+datum=NAD83 +units=m +no_defs +ellps=GRS80 +towgs84=0,0,0")
studyAreaReporting <- LandR::randomStudyArea(size = 10000 * 250 * 30000, center = center, seed = 1002)
studyAreaReporting <- st_as_sf(studyArea)
