...
rasterToMatch <- LandR::prepInputsStandAgeMap(destinationPath = 'inputs')
...
vegMap <- prepInputsLCC(year = 2010, destinationPath = "inputs", rasterToMatch = rasterToMatch)
...
flammableMap <- defineFlammable(LandCoverClassifiedMap = vegMap,
