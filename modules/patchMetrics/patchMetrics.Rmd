...
moduleDir <- file.path("/Users/stevec/Dropbox/Courses/7043H17/Lab/scfmModules")
...
If `sourceURL` is specified, `downloadData("patchMetrics", "path/to/modules/dir")` may be sufficient.
