defineModule(sim, list(
  ...
  inputObjects = bindrows(
    expectsInput("fireRegimeRas", "SpatRaster", desc = "raster with fire regimes from `fireRegimePolys`."),
    expectsInput("flammableMap", "SpatRaster", desc = "binary map of landscape flammability"),
