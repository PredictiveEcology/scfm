...
rasterToMatch <- LandR::prepInputsLCC(year = 2010, studyArea = studyArea, useSAcrs = TRUE, destinationPath = paths$inputPath)
rasterToMatch <- raster::aggregate(rasterToMatch, fact = 8) #for speed, this is close to 2005's 250m resolution

#this is a silly workaround to a SpaDES recoveryMode issue when prepInputsLCC is called again in module
