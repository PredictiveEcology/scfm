...
rasterToMatchLarge <- LandR::prepInputsStandAgeMap(studyArea = studyAreaLarge, 
                                                   destinationPath = paths$inputPath,
                                                   fireURL = NULL)
rasterToMatch <- postProcess(rasterToMatchLarge, studyArea = studyArea)

#necessary for scfm - use ageMap crs to avoid reprojecting the flammableMap interanlly, or supply your own flammableMaps
studyArea <- spTransform(studyArea, CRSobj = crs(studyArea))
studyAreaLarge <- spTransform(studyAreaLarge, CRSobj = crs(studyAreaLarge))
...
mySim <- simInit(times = times, params = parameters, modules = c("scfmLandcoverInit", "scfmRegime"),
