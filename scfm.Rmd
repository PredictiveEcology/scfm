...
library(sp)
library(raster)
#library(data.table) #debugging this
```
...
options("Require.unloadNamespaces" = FALSE) #this is necessary while rgeos continutes to be used. 
...
rasterToMatch <- LandR::prepInputsStandAgeMap(studyArea = studyArea, 
                                              destinationPath = paths$inputPath, 
                                              fireURL = NULL)
studyArea <- spTransform(studyArea, CRSobj = crs(rasterToMatch))
